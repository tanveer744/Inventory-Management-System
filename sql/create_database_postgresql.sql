-- ===================================================================
-- Inventory Management System - PostgreSQL Database Creation Script
...
-- ===================================================================
CREATE TYPE transaction_type AS ENUM ('PURCHASE', 'SALE', 'RETURN_IN', 'RETURN_OUT', 'ADJUSTMENT');
...
BEGIN
    IF NEW.transaction_type IN ('SALE', 'RETURN_OUT') THEN
        ...
        IF current_stock < NEW.quantity THEN
            RAISE EXCEPTION 'Insufficient stock for this transaction. Available: %, Requested: %', 
